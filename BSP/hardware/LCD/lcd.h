...
/******************************************************************************************/
/* MCU引脚、GPIO属性和FSMC片选配置统一由项目侧 lcd_port.h 提供。 */
...
#define LCD_BL(x)   do{ x ? \
                      HAL_GPIO_WritePin(LCD_BL_GPIO_PORT, LCD_BL_GPIO_PIN, LCD_BL_ACTIVE_STATE) : \
                      HAL_GPIO_WritePin(LCD_BL_GPIO_PORT, LCD_BL_GPIO_PIN, LCD_BL_INACTIVE_STATE); \
                     }while(0)
