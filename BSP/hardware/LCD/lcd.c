 ...
 * @retval      无
 */
static void lcd_gpio_init_fsmc_pin(GPIO_TypeDef *gpio_port, uint32_t gpio_pin)
{
    GPIO_InitTypeDef gpio_init_struct;

    gpio_init_struct.Pin = gpio_pin;
    gpio_init_struct.Mode = LCD_FSMC_GPIO_MODE;
    gpio_init_struct.Pull = LCD_FSMC_GPIO_PULL;
    gpio_init_struct.Speed = LCD_FSMC_GPIO_SPEED;
...
void HAL_SRAM_MspInit(SRAM_HandleTypeDef *hsram)
{
    ...
    LCD_FSMC_CLK_ENABLE();
    LCD_FSMC_GPIO_CLK_ENABLE();

    lcd_gpio_init_fsmc_pin(LCD_D0_GPIO_PORT, LCD_D0_GPIO_PIN);
    lcd_gpio_init_fsmc_pin(LCD_D1_GPIO_PORT, LCD_D1_GPIO_PIN);
    lcd_gpio_init_fsmc_pin(LCD_D2_GPIO_PORT, LCD_D2_GPIO_PIN);
    lcd_gpio_init_fsmc_pin(LCD_D3_GPIO_PORT, LCD_D3_GPIO_PIN);
    lcd_gpio_init_fsmc_pin(LCD_D4_GPIO_PORT, LCD_D4_GPIO_PIN);
    lcd_gpio_init_fsmc_pin(LCD_D5_GPIO_PORT, LCD_D5_GPIO_PIN);
    lcd_gpio_init_fsmc_pin(LCD_D6_GPIO_PORT, LCD_D6_GPIO_PIN);
    lcd_gpio_init_fsmc_pin(LCD_D7_GPIO_PORT, LCD_D7_GPIO_PIN);
    lcd_gpio_init_fsmc_pin(LCD_D8_GPIO_PORT, LCD_D8_GPIO_PIN);
    lcd_gpio_init_fsmc_pin(LCD_D9_GPIO_PORT, LCD_D9_GPIO_PIN);
    lcd_gpio_init_fsmc_pin(LCD_D10_GPIO_PORT, LCD_D10_GPIO_PIN);
    lcd_gpio_init_fsmc_pin(LCD_D11_GPIO_PORT, LCD_D11_GPIO_PIN);
    lcd_gpio_init_fsmc_pin(LCD_D12_GPIO_PORT, LCD_D12_GPIO_PIN);
    lcd_gpio_init_fsmc_pin(LCD_D13_GPIO_PORT, LCD_D13_GPIO_PIN);
    lcd_gpio_init_fsmc_pin(LCD_D14_GPIO_PORT, LCD_D14_GPIO_PIN);
    lcd_gpio_init_fsmc_pin(LCD_D15_GPIO_PORT, LCD_D15_GPIO_PIN);
}
...
void lcd_init(void)
{
    ...
    lcd_gpio_init_fsmc_pin(LCD_CS_GPIO_PORT, LCD_CS_GPIO_PIN);
    lcd_gpio_init_fsmc_pin(LCD_WR_GPIO_PORT, LCD_WR_GPIO_PIN);
    lcd_gpio_init_fsmc_pin(LCD_RD_GPIO_PORT, LCD_RD_GPIO_PIN);
    lcd_gpio_init_fsmc_pin(LCD_RS_GPIO_PORT, LCD_RS_GPIO_PIN);

    gpio_init_struct.Pin = LCD_BL_GPIO_PIN;
    gpio_init_struct.Mode = LCD_BL_GPIO_MODE;
    gpio_init_struct.Pull = LCD_BL_GPIO_PULL;
    gpio_init_struct.Speed = LCD_BL_GPIO_SPEED;
    ...
    g_sram_handle.Init.NSBank = LCD_FSMC_NORSRAM_BANK;                     /* 使用LCD_CS对应的NEx */
